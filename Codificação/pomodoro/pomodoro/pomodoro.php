...
<div id="modal-tarefa" class="modal">
    <div class="modal-content">
        ...
        <form class="col s12">
            ...
            <div class="input-field col s6">
                    <i class="material-icons prefix">event_note</i>
                    <input id="ipt-nomeatv" type="text" class="validate">
                    <label for="ipt-nomeatv">Nome</label>
                </div>
                <div class="input-field col s6">
                    <i class="material-icons prefix">event_note</i>
                    <input id="ipt-pomodoroprevisto" type="number" class="validate">
                    <label for="ipt-pomodoroprevisto">Pomodoro Previsto</label>
                </div>
                <div class="input-field col s6">
                    <i class="material-icons prefix">event_note</i>
                    <input id="ipt-pomodorodata" type="date" class="validate">
                    <label for="ipt-pomodorodata">Data Limite da Tarefa</label>
                </div>
            </div>
        </form>
    </div>
